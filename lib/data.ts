...
export const BLOG_POSTS = [
  ...
  { id: "3", title: "The Complete Guide to Home HVAC Systems",                 category: "HVAC",     excerpt: "Understanding your heating and cooling system helps you make smarter decisions about maintenance, repairs, and replacement.", readTime: "9 min", date: "May 29, 2025", author: "Robert Williams", slug: "complete-guide-hvac-systems",                  image: "https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=800&q=80" },
  ...
  { id: "5", title: "5 Signs Your Home Needs an Electrical Panel Upgrade",      category: "Electrical",   excerpt: "An outdated or overloaded panel is one of the most common — and most overlooked — electrical hazards in American homes. Here's what to watch for.", readTime: "6 min", date: "June 22, 2025", author: "James Carter",    slug: "electrical-panel-upgrade-signs",     image: "https://images.unsplash.com/photo-1621905251189-08b45d6a269e?w=800&q=80" },
  { id: "6", title: "EV Charger Installation: What Every Homeowner Should Know", category: "Electrical",  excerpt: "Adding an EV charger to your home is one of the best upgrades you can make — but the installation involves more than just plugging something in.", readTime: "7 min", date: "June 17, 2025", author: "Robert Williams",  slug: "ev-charger-installation-guide",      image: "https://images.unsplash.com/photo-1593941707882-a5bba14938c7?w=800&q=80" },
  { id: "7", title: "How to Plan a Backyard Renovation on Any Budget",           category: "Landscaping", excerpt: "A great backyard doesn't require a six-figure budget. Smart planning and the right contractor make all the difference — at any price point.", readTime: "8 min", date: "June 12, 2025", author: "Maria Gonzalez",   slug: "backyard-renovation-budget-planning", image: "https://images.unsplash.com/photo-1558904541-efa843a96f01?w=800&q=80" },
  { id: "8", title: "Best Plants for Low-Maintenance Landscaping in the US",     category: "Landscaping", excerpt: "The right plant selection can transform your yard into a stunning, nearly self-sufficient landscape — no green thumb required.", readTime: "6 min", date: "June 5, 2025",  author: "Sarah Thompson",  slug: "low-maintenance-landscaping-plants",  image: "https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=800&q=80" },
];
